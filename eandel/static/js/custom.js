    ...
    */
    ...
    function initContactForm(argument) {
        $("#contact").submit(function(e) {
            ...
            var dataString = 'name=' + name + '&email=' + email + '&subject=' + subject + '&msg=' + message + '&csrfmiddlewaretoken=' + csrf;
    ...
    function initGoogleMapsDark() {
        ...
        var mapOptions = {
            ...
            center: new google.maps.LatLng(6.565127, 3.384455), // New york
        ...
        var marker = new google.maps.Marker({
            position: new google.maps.LatLng(6.565127, 3.384455),
            map: map,
            title: 'Find us here!'
        });
    }
